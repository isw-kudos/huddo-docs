...
| Google          | [Instructions](../google/instructions.md)                                                                     | `https://[BOARDS_URL]/auth/google/callback`      |
...
Install the Boards services using the latest [huddo-boards helm upgrade command](../helm-charts.md#huddo-boards).
